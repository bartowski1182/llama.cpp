...
const char * llama_ftype_name(llama_ftype ftype) {
    ...
    switch ((enum llama_ftype) (ftype & ~LLAMA_FTYPE_GUESSED)) {
        ...
        case LLAMA_FTYPE_MOSTLY_IQ2_MX:    name = LLAMA_FTYPE_PREFIX "IQ2_MX"; break;
        case LLAMA_FTYPE_MOSTLY_IQ3_MX:    name = LLAMA_FTYPE_PREFIX "IQ3_MX"; break;
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_IQ2_MX:  ftype = LLAMA_FTYPE_MOSTLY_IQ2_MX;  break;
            case GGML_TYPE_IQ3_MX:  ftype = LLAMA_FTYPE_MOSTLY_IQ3_MX;  break;
            default:
                {
