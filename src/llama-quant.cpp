...
static ggml_type tensor_type_fallback(quantize_state_impl & qs, const ggml_tensor * t, const ggml_type target_type) {
    ...
    if (ncols % qk_k != 0) { // this tensor's shape is incompatible with this quant
        ...
        switch (target_type) {
            ...
            case GGML_TYPE_Q2_0:
            case GGML_TYPE_IQ2_MX:  // block size 64
        ...
        if (qs.params->token_embedding_type < GGML_TYPE_COUNT) {
            ...
            if (ftype == LLAMA_FTYPE_MOSTLY_IQ2_XXS || ftype == LLAMA_FTYPE_MOSTLY_IQ2_XS ||
                ...
                new_type = GGML_TYPE_IQ3_S;
                     ...
                     ftype == LLAMA_FTYPE_MOSTLY_IQ2_MX || ftype == LLAMA_FTYPE_MOSTLY_IQ3_MX) {
...
ggml_type llama_ftype_get_default_type(llama_ftype ftype) {
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_IQ2_MX: return GGML_TYPE_IQ2_MX;
        case LLAMA_FTYPE_MOSTLY_IQ3_MX: return GGML_TYPE_IQ3_MX;
