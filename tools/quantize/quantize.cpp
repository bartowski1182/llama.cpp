...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "IQ2_MX",   LLAMA_FTYPE_MOSTLY_IQ2_MX,   " 2.75 bpw codebook quant for MXFP4-sourced models", },
    { "IQ3_MX",   LLAMA_FTYPE_MOSTLY_IQ3_MX,   " 3.25 bpw codebook quant for MXFP4-sourced models", },
