    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_IQ2_MX  ? MAX_QUANTIZATION_TOTAL_ERROR_TERNARY :
                type == GGML_TYPE_IQ3_MX  ? MAX_QUANTIZATION_TOTAL_ERROR_TERNARY :
            ...
            const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                ...
                // the iq2_mx / iq3_mx codebooks are trained for MXFP4-sourced weights;
                // on the synthetic test distribution their error is between ternary and
                // binary
                : type == GGML_TYPE_IQ2_MX || type == GGML_TYPE_IQ3_MX
                ? MAX_DOT_PRODUCT_ERROR_BINARY
