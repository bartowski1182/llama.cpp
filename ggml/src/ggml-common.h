...
// 2.75 bpw class-conditional magnitude codebook, designed for MXFP4-sourced weights.
// Each 64-weight block holds two independent 32-weight halves. Per half: one scale
// byte (low 7 bits: biased power-of-two exponent, value = 2^(e-63); top bit: which
// of the two codebook classes to use). Per weight: 1 sign bit. Per 4 weights: a
// 6-bit index into a 64-entry 4-dim magnitude codebook (iq2mx_grid, units of 1/32).
#define QK_IQ2MX 64
typedef struct {
    uint8_t scales[2]; // per 32 weights: 7-bit exponent + class bit (top)
    uint8_t signs[8];  // 1 bit per weight, 1 = negative
    uint8_t qs[12];    // 16 x 6-bit codebook index
} block_iq2_mx;
static_assert(sizeof(block_iq2_mx) == 22, "wrong iq2_mx block size/padding");

// 3.25 bpw class-conditional magnitude codebook, the k=256 sibling of IQ2_MX.
// Same block layout and scale semantics, except that the per-4-weight index is a
// plain byte selecting one of 256 entries of iq3mx_grid.
#define QK_IQ3MX 64
typedef struct {
    uint8_t scales[2]; // per 32 weights: 7-bit exponent + class bit (top)
    uint8_t signs[8];  // 1 bit per weight, 1 = negative
    uint8_t qs[16];    // 16 x 8-bit codebook index
} block_iq3_mx;
static_assert(sizeof(block_iq3_mx) == 26, "wrong iq3_mx block size/padding");
...
// IQ2_MX magnitude codebook: 2 classes x 64 entries x 4 dims, units of 1/32 of the
// block scale. Class 0: blocks whose max magnitude is ~4x scale; class 1: ~6x scale.
// Trained (weighted k-means) on MXFP4 expert tensors of DeepSeek-V4-Flash-0731,
// gpt-oss-20b and gpt-oss-120b, pooled equally.
GGML_TABLE_BEGIN(uint8_t, iq2mx_grid, 512)
     55,  17,  37,  33,  20,  29,  13,  17,   4,  15,   9,  44,   8,   5,  19,   8,
     59,  16,  74,  57, 110,  21,  81,  26,  56,   6,  14,  51,  56, 109,  18,  21,
     24,  48,  57,  10, 108,  53,  47,  26,  45,  29, 106, 110,   3,   6,   0,   3,
     33, 107,  28, 109,  17,  14, 117,  14, 108, 107,  29,  34,  27,   6,  21,  56,
     61, 109,  58,  27,  19,  56,  45,  56,  18,  14, 102,  50,  30,  10,  45,   9,
     11,  10,  58,  20,   8,  56,  14,  58,  56,  33,  36,  58,  56,  23,  57,  15,
     56,   0,  49,  16,  24,  96,  24,  50, 109,  74, 110,  50, 109,  50,   9,  28,
     51,  61,  14,  56,  61,  18, 113,  24,  56,  57,  18,  20,  31, 108,  85,  85,
     19,  42, 121,  68,  54,  56, 114,  20,  37,  57,  16, 110,  15,  55,   9,  22,
     28,  34,   7,  53, 109,  21,  28,  57, 108,  75,  33,  97,  14,  58,  41,  26,
     48,  58,  69,  54,  26,  53,  23,   7,  24, 128,  22,  49,  17,  54,  56, 107,
     32, 108, 109,  28, 108,  21,  34, 109,  20,  17,  36,  29,  56,  25,   9,  38,
      8,  26,  33,   6,  56,  56,  56,  18,  52,  28,  53, 109,  19,  17,  56,  56,
    110,  15,  24,  16,  14,  17,  30,  96,  16,  49, 102,  21,  18, 109,  57,  22,
     50,  17,  15, 106,  58,  30,  17,   9,  12,  24,  28,  58,  16,  18,  25, 128,
     43,   9,  13,   9,  22,  10,   7,  27,   9,  36,  55,  26,  16, 110,  16,  11,
     60,  17,  63,  53, 192,  32,  93,  41,  48, 192,  39, 112, 192,  21,  22,  29,
     20,  23, 104,  51,  39,  85,  94, 192, 110, 115,  31,  40,  34,  68,  20,  60,
     50, 107,  20,  30,  38,  22,  90, 192, 129,  45,  51, 192,  80,  46, 192, 162,
     28,  31,  20,   3, 110,  24, 112,  40,  37,  13,  34,  19,  28, 112,  70,  96,
     11, 111,  33,  30,  18,  60,  20,  20,  20,  50,  64,  72,  18,  25,  16,  58,
    109,  11,  52,  61,  40,  13,  89,  11,  32, 192,  32,  32, 192, 120,  99,  72,
    192,  46,  38, 111,  51, 121,  89,  33,  33,  32,  21, 192,  25,  28,  49, 128,
     12,   8,  50,  42, 141, 122, 192,  67,  31,  23, 128,  18,  37, 125, 157, 118,
     83,  49,  46, 112, 114,  43,  18,  73,  60,  52,  20,  15, 192,  88,  32,  32,
      6,  41,  65,  15,  32,  32, 192,  22,  17,  92, 114,  33,  22,  84,  19, 110,
     60,  49, 113,  47,  42, 122, 192,  33,  71,  22,  16, 109,  31,  13,   4,  22,
    117, 131, 101, 132,  62,  20,  19,  47,  46,  33,  60,  20,  36,  34, 110, 110,
     51, 192, 108,  47, 110,  73,  71,  42,  47,  74,  66,  25, 108,  32,  68,  12,
      3,  15,  14,  12, 107,  68,  20,  18,  31,  34, 192,  86, 126, 192,  39,  42,
    107,  19,  20,  22, 116,  36, 102, 111,  50, 131,  32, 192,  33,   7,  49,  84,
     18,  25,  15, 103, 122,  33, 192,  45,  89, 110,  30, 110, 105, 102, 115,  31,
GGML_TABLE_END()

// IQ3_MX magnitude codebook: 2 classes x 256 entries x 4 dims, units of 1/32 of the
// block scale. Class 0: blocks whose max magnitude is ~4x scale; class 1: ~6x scale.
// Trained (weighted k-means) on MXFP4 expert tensors of DeepSeek-V4-Flash-0731,
// gpt-oss-20b and gpt-oss-120b, pooled equally.
GGML_TABLE_BEGIN(uint8_t, iq3mx_grid, 2048)
     21,  36,  64,   0, 109, 107, 107,  29,  27, 108, 107, 109, 107, 108,  34,  57,
     19,  54,   4,  60,  28,   0,  54,  41,  64,  57,  25,  51,  32,   0,  16,   7,
     26,  54, 128,  34,   0,  12,  54,  19,  59,  10,  58,   0,  35,  59,  29,  96,
     13,  58,  44,   0,  56,  19,  96,  39,  21,  38,  96,  36,  35,  13,  36,  16,
      8,  58, 102,  61,  23, 128, 104,  18,  10,  16,  16,   0,  11,  32,   0,  32,
     58,   0,  26,   0,  13,  35,  35,  13,  34,  26,   0,  37, 128,  56,  46,  18,
    128,  14,  16,  40,  39,  96,   9,  36,  28,  48,  54,  54,  18,  27,  16,  96,
     16,   0,  16,   0, 128,  10,   9,   9,  25,  18,  61,  96,   7,  40,  61,  59,
     48,  48,  39,  32,  37,  53, 117,  96,  15,  50,   0,  23,  19, 128,  16,  36,
    104, 108,  15,  20,  17,  19,   0,  96, 128,  61,  12,  50, 107,  17, 106,  14,
     20,  61,  25,  59,  13,  96,  29,   0,  18,  96,  38,  24,  37,  32,  32,  53,
      0,   0,  16,   0,  23,  32,  16,  32,  12,  37,  32,  48,  64,   0,  17,  39,
     32,  16,  16,  16,  16,  16,  16,  16,  96,  28,  19,  21, 107, 107,  33, 107,
     64,  60,  43,  35,  41,   0,  23,  36,  96,  18,  25,  96,  52,  24,  20,  48,
     16,  64,  39,  23,  64,  10,   0,  10,  11,   9,  40, 128,  36,  16,  21,  32,
     28,  58,  96,  47,  34,  14,  96,  21,   0,  58,  26,  64,  16,  12,  32,  11,
     34,  61,  28,  28,  27,  96,  61,  16,  56,  43,   0,   7,  55,   0,  16,  16,
     57, 107,  46, 109,  44,   5,   0,  17,   9,  45,  37,  96,  77,  13,  49, 128,
     11,  22,  96,  19,   0,  37,   0,  53, 128,  21,  54,   9,  26,  48,  44,  20,
     64,  12,  32,  12,  50,   0,  51,  59,   9,   7, 128,   9,  20,  18,  96,   0,
     56,  21,  57,  52,  32,  61,  57,  25,  12,  11,   8, 128, 128,  17,  20,  79,
     10,   0,   0,  12,  24,  19,  56,  64,  20, 107, 108,  56,  45,  64,  45,  58,
     15,  32,  21,  64,   0,  21,  20,  16,   9,   2,  29,  60,  32,  53,  32,  53,
     32,  11,  19,  96, 110,  26,  96,  51, 128,   7,  35,  13,  64,  37,  13,  13,
     55,  27,  13, 128,  57,  64,  37,   9, 108,  57, 106,  20,   4,   4,  34,   4,
      4,  44, 128,  27,   0,  34,  59,  15,  18, 113,  54, 100,  16,  26,   0,  60,
     10,  23,  48,   0,  16,  21, 107,  96,  57, 128,  40,  48,  56,  20,  96,  10,
      8,  10, 128,  35,  38,  15,  96,  59,  39,  55,   0,  39,  23,   0,   0,  38,
      7,  96,  48,  48,   8,   3,  59,  35,   9,  42,  20, 128,  19,  21,  55,  34,
     32,  16,  16,   0,  38,  32,  32,  32, 104,  29, 128,  49,  18,  59,  11,  13,
      8,   0,  96,  21,  62,  65,  64,   9,   0,  25,  96,  43,   9,  36, 128,  57,
    117,  37,  91, 108,  64,  24,  57,  14,  18,  64,  64,  56,  17,  56,  96,  12,
     39,   8,  22, 128,  18,  76,  56, 128,  96,  20,  47,  57,  32,  23,  32,   0,
     96,  56,  56,  25,  52,  31,   4,  29,   0,  59,  12,  21,  33,  56, 105, 128,
     60,  22,  96,  45,  29,   6,  35,  35,  18,   6, 109,   6,   2,   3,  24,  32,
     96,  50,  43,  57, 128,  62, 103,  42,  63,  31,   3,  82,  31,  94, 192, 110,
     35,  61,  62,  30, 127, 126,  45, 192,  96,  51,  64,  51,   6,   4,   0,   0,
    110, 192,  87,  33,   0,  27,  27,   7, 109, 192,  20,  29,  21,  16,  38,  12,
