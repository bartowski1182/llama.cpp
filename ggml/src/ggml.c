...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_IQ2_MX] = {
        .type_name                = "iq2_mx",
        .blck_size                = QK_IQ2MX,
        .type_size                = sizeof(block_iq2_mx),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq2_mx,
        .from_float_ref           = (ggml_from_float_t) quantize_row_iq2_mx_ref,
    },
    [GGML_TYPE_IQ3_MX] = {
        .type_name                = "iq3_mx",
        .blck_size                = QK_IQ3MX,
        .type_size                = sizeof(block_iq3_mx),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_iq3_mx,
        .from_float_ref           = (ggml_from_float_t) quantize_row_iq3_mx_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_IQ2_MX:        wtype = GGML_TYPE_IQ2_MX; break;
        case GGML_FTYPE_MOSTLY_IQ3_MX:        wtype = GGML_TYPE_IQ3_MX; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_IQ2_MX:  result = quantize_iq2_mx (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_IQ3_MX:  result = quantize_iq3_mx (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
