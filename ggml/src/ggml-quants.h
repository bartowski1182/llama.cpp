...
GGML_API void quantize_row_iq2_mx_ref (const float * GGML_RESTRICT x, block_iq2_mx  * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_iq3_mx_ref (const float * GGML_RESTRICT x, block_iq3_mx  * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_iq2_mx(const block_iq2_mx * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_iq3_mx(const block_iq3_mx * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_iq2_mx(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq3_mx(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
